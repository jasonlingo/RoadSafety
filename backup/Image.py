...
from config import VIDEO_FRAME_DIRECTORY, IMAGE_QUALITY, RESIZE_X, GPS_DISTANCE, CSV_FILENAME, FOLDER_NAME, OUTPUT_DIRECTORY
...
def flipImage(filename, flip, resize):
